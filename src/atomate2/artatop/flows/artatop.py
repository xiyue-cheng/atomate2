...
class ArtatopWorkflowMaker(Maker):
    ...
    def make(self, structure: Structure, prev_dir: str | Path, additional_metadata: Optional[dict] = None) -> Flow:
        ...
        relax_generator = RelaxSetGenerator(user_incar_settings={"NPAR": 1, "ENAUG": None, "GGA": None, "MAGMOM": None, "SIGMA": None})
        ...
        self.optics_maker.static_maker.input_set_generator.user_incar_settings = {"LORBIT": 10, "NPAR": 1, "ENAUG":None, "GGA":None, "MAGMOM": None, "SIGMA": None}
        self.optics_maker.band_structure_maker.input_set_generator = NonSCFSetGenerator(
            optics=True,
            nbands_factor=4.0,
            user_incar_settings={"LORBIT": 10, "CSHIFT": 0.1, "NPAR":1, "ENAUG": None, "GGA": None, "MAGMOM": None, "SIGMA": None},
        )
        
        hse_generator = HSEStaticSetGenerator(user_incar_settings={"NPAR": 1, "ENAUG": None, "GGA": None, "MAGMOM": None, "SIGMA": None})
